...
<div className="not-prose mx-auto my-6 w-full max-w-xl rounded-2xl border border-gray-200 bg-gray-50 p-5 dark:border-white/10 dark:bg-white/[0.03]">
  ...
  <div className="mt-3 flex flex-col gap-2 sm:flex-row sm:items-stretch">
    <input
      ...
      className="h-11 w-full min-w-0 flex-1 rounded-full border border-gray-200 bg-white px-4 text-sm text-gray-900 outline-none ring-0 placeholder:text-gray-400 focus:border-indigo-400 dark:border-white/10 dark:bg-white/[0.04] dark:text-gray-50 dark:placeholder:text-gray-500"
    />
    <button
      type="button"
      data-ptly-start
      className="h-11 shrink-0 cursor-pointer rounded-full bg-indigo-600 px-5 text-sm font-semibold text-white transition hover:bg-indigo-500"
    >
      Start my test
    </button>
  </div>
